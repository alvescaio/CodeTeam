...
<body>
		...
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner">
			    ...
			    <ul class="dropdown-menu">
				    <li><a href=""><i class="icon-list"></i> Activities</a></li>	
				    <li class="divider"></li>
				    <li><a href="#"><i class="icon-pencil"></i> Edit</a></li>	
				    <li><a href="#"><i class="icon-trash"></i> Delete</a></li>
				    <li class="divider"></li>
				    <li><a href="post_matter.php"><i class="icon-list"></i> Matters</a></li>
					<li class="divider"></li>
				    <li><a href="#"><i class="icon-pencil"></i> Edit</a></li>	
				    <li><a href="#"><i class="icon-trash"></i> Delete</a></li>
				    <li class="divider"></li>
	...
	<div class="container">
		<div class="row">
			...
			<form class="form-center" action="../../php/functions.php" method="post" >
				...
				<button type="submit" name="post-activity" class="adjust-btn btn btn-primary">Post</button>
			</form>
		</div>
	</div>
	...
	<!--Scripts-->
	 ...
	 <script src="../../js/datapicker.js" type="text/javascript"></script>
	  <script type="text/javascript">$(document).ready(function () {$('#dp').datepicker({format: "yyyy/mm/dd"});  });</script>
	</body>
	</html>
